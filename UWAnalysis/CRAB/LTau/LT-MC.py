...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
       '/store/user/tapas/localPatTuple/VBF_HToTauTau_M-120_8TeV-powheg-pythia6/FED5F7FE-0597-E111-BE71-485B39800BB5_PatTuple.root'
       #'file:/afs/hep.wisc.edu/cms/swanson/PhilOutput_Patuple.root'
		),
...
addMuTauEventTree(process,'muTauEventTreeSync','diTausLooseTauIsolation','diMuonsSorted')
...
addMuTauEventTree(process,'muTauEventTreeSyncTauUp','diTausLooseTauIsolationTauUp','diMuonsSortedTauUp')
addMuTauEventTree(process,'muTauEventTreeSyncTauDown','diTausLooseTauIsolationTauDown','diMuonsSortedTauDown')
...
addEleTauEventTree(process,'eleTauEventTreeSyncTauUp','eleTausLooseIsolationTauUp','osDiElectronsTauUp')
addEleTauEventTree(process,'eleTauEventTreeSyncTauDown','eleTausLooseIsolationTauDown','osDiElectronsTauDown')
