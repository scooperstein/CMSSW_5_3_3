...
EventWeightsIterative outputFile='bbA160.root'    doOneD=1     weight=1    type=7 histoName='MT/results' 
EventWeightsIterative outputFile='bbA180.root'    doOneD=1     weight=1    type=7 histoName='MT/results' 
EventWeightsIterative outputFile='bbA200.root'    doOneD=1     weight=1    type=7 histoName='MT/results' 
EventWeightsIterative outputFile='bbA250.root'    doOneD=1     weight=1    type=7 histoName='MT/results' 
EventWeightsIterative outputFile='bbA300.root'    doOneD=1     weight=1    type=7 histoName='MT/results' 
